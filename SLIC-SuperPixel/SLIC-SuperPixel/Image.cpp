 ...
 * Created on September 11, 2016, 2:18 PM
 ...
 //EDIT: antes de cada função pow botei (double). AMK
 */
...
Pixel Image::XYZToLab( Pixel XYZ )
{
    ...
    if (XYZ[0] > 0.008856)
    {
        XYZ[0] = pow( (double)XYZ[0], ( 1.0 / 3.0 ) );
    }
    else
    {
    ...
    if (XYZ[1] > 0.008856)
    {
        XYZ[1] = pow( (double)XYZ[1], ( 1.0 / 3.0 ) );
    }
    else
    {
    ...
    if (XYZ[2] > 0.008856)
    {
        XYZ[2] = pow( (double)XYZ[2], ( 1.0 / 3.0 ) );
    }
    else
    {
...
Pixel Image::XYZTorgb( Pixel XYZ )
{
    ...
    if (rgb[0] > 0.0031308)
    {
        rgb[0] = 1.055 * pow( (double)rgb[0], ( 1 / 2.4 ) ) - 0.055;
    }
    else
    {
        rgb[0] = 12.92 * rgb[0];
    ...
    if (rgb[1] > 0.0031308)
    {
        rgb[1] = 1.055 * pow( (double)rgb[1], ( 1 / 2.4 ) ) - 0.055;
    }
    else
    {
        rgb[1] = 12.92 * rgb[1];
    ...
    if (rgb[2] > 0.0031308)
    {
		...
		rgb[2] = 1.055 * pow((double)rgb[2], ( 1 / 2.4 ) ) - 0.055;
    }
    else
    {
        rgb[2] = 12.92 * rgb[2];
